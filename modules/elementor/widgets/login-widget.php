...
class RM_Panel_Login_Widget extends \Elementor\Widget_Base {
    ...
    private function register_input_styles() {
        ...
        $this->add_control(
                'input_normal_border_color', // ✅ CHANGED from 'input_border_color'
                [
        ...
        $this->add_control(
                'input_focus_border_color', // ✅ This one is already correct
                [
                    'label' => __('Border Color', 'rm-panel-extensions'),
                    'type' => \Elementor\Controls_Manager::COLOR,
                    'default' => '#007cba',
    ...
    private function get_register_url($settings) {
        $url = !empty($settings['custom_register_url']['url']) ? $settings['custom_register_url']['url'] : wp_registration_url();
    ...
    private function get_lost_password_url($settings) {
        $url = !empty($settings['custom_lost_password_url']['url']) ? $settings['custom_lost_password_url']['url'] : wp_lostpassword_url();
