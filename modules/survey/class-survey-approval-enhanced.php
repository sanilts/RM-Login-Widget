<?php
/**
 * Enhanced Survey Approval System
 * Tracks approver and adds to user's withdrawable balance
 * 
...
class RM_Survey_Approval_Enhanced {
    ...
    public function __construct() {
        ...
        // Override existing approval admin
    ...
    public function add_admin_menu() {
        ...
        remove_submenu_page('rm-panel-extensions', 'rm-survey-approvals');
            ...
            <div class="notice notice-warning is-dismissible">
                <p>
                    ...
                    printf(
                        ...
                        $pending_count,
                        admin_url('edit.php?post_type=rm_survey&page=rm-survey-approvals-v2')
                    );
                    ?>
                </p>
            </div>
    ...
    public function render_approval_page() {
        ...
        // Get responses with user and survey details
        $query = "SELECT 
                    r.*,
                    u.display_name,
                    u.user_email,
        ...
        <div class="wrap">
            ...
            <ul class="subsubsub">
                <li>
                    <a href="?post_type=rm_survey&page=rm-survey-approvals-v2&approval_status=pending" 
                       class="<?php echo $status_filter === 'pending' ? 'current' : ''; ?>">
                        <?php printf(__('Pending Approval (%d)', 'rm-panel-extensions'), $pending_count); ?>
                    </a> |
                </li>
                <li>
                    <a href="?post_type=rm_survey&page=rm-survey-approvals-v2&approval_status=approved" 
                       class="<?php echo $status_filter === 'approved' ? 'current' : ''; ?>">
                        <?php printf(__('Approved (%d)', 'rm-panel-extensions'), $approved_count); ?>
                    </a> |
                </li>
                <li>
                    <a href="?post_type=rm_survey&page=rm-survey-approvals-v2&approval_status=rejected" 
    ...
    public function enqueue_scripts($hook) {
        if ($hook !== 'rm_survey_page_rm-survey-approvals-v2') {
            return;
        }
    ...
    public function ajax_approve() {
        ...
        $current_balance = get_user_meta($user_id, 'rm_withdrawable_balance', true) ?: 0;
...
// Initialize
new RM_Survey_Approval_Enhanced();